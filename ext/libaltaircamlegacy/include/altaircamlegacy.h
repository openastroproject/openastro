...
#define TOUPCAM_FLAG_COOLED             0x00000080  /* Cooled */
...
#define TOUPCAM_FLAG_COOLERONOFF        0x00020000  /* cooler can be turn on or off */
...
#define TOUPCAM_AETARGET_MAX            235
...
toupcam_ports(HRESULT)  Toupcam_Trigger(HToupCam h); /* soft trigger */
/*
...
#define TOUPCAM_OPTION_COOLER               0x08    /* 0 = turn off cooler, 1 = turn on cooler */
#define TOUPCAM_OPTION_LINEAR               0x09    /* 0 = turn off tone linear, 1 = turn on tone linear */
#define TOUPCAM_OPTION_CURVE                0x0a    /* 0 = turn off tone curve, 1 = turn on tone curve */
