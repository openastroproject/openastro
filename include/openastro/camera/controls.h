...
#define	OA_CAM_CTRL_FOCUS_RELATIVE_SPEED	92
...
#define	OA_CAM_CTRL_LAST_P1		OA_CAM_CTRL_ROLL_RELATIVE_SPEED+1
...
#define OA_CAM_CTRL_MODE_NONAUTO(x)	( x & ~OA_CAM_CTRL_MODIFIER_AUTO_MASK )
