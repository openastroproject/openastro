  ...
  switch ( control ) {
    ...
    case OA_CAM_CTRL_BRIGHTNESS:
      ...
      if ( val >= TOUPCAM_BRIGHTNESS_MIN && val <= TOUPCAM_BRIGHTNESS_MAX ) {
        if (( *p_Altaircam_put_Brightness )( cameraInfo->handle, val )) {
    ...
    case OA_CAM_CTRL_CONTRAST:
      ...
      if ( val >= TOUPCAM_CONTRAST_MIN && val <= TOUPCAM_CONTRAST_MAX ) {
        if (( *p_Altaircam_put_Contrast )( cameraInfo->handle, val )) {
    ...
    case OA_CAM_CTRL_GAMMA:
      ...
      if ( val >= TOUPCAM_GAMMA_MIN && val <= TOUPCAM_GAMMA_MAX ) {
        if (( *p_Altaircam_put_Gamma )( cameraInfo->handle, val )) {
    ...
    case OA_CAM_CTRL_HFLIP:
      ...
      if (( *p_Altaircam_put_HFlip )( cameraInfo->handle, val )) {
    ...
    case OA_CAM_CTRL_VFLIP:
      ...
      val = valp->boolean ? 1 : 0;
      if (( *p_Altaircam_put_VFlip )( cameraInfo->handle, val )) {
    ...
    case OA_CAM_CTRL_MODE_AUTO( OA_CAM_CTRL_EXPOSURE_ABSOLUTE ):
      ...
      if (( *p_Altaircam_put_AutoExpoEnable )( cameraInfo->handle, val )) {
    ...
    case OA_CAM_CTRL_EXPOSURE_ABSOLUTE:
      ...
      if ( val >= cameraInfo->exposureMin && val <= cameraInfo->exposureMax ) {
        if (( *p_Altaircam_put_ExpoTime )( cameraInfo->handle, val )) {
    ...
    case OA_CAM_CTRL_GAIN:
      ...
      if ( val >= cameraInfo->gainMin && val <= cameraInfo->gainMax ) {
        if (( *p_Altaircam_put_ExpoAGain )( cameraInfo->handle, val )) {
    ...
    case OA_CAM_CTRL_SPEED:
      ...
      if ( val >= 0 && val <= cameraInfo->speedMax ) {
        if (( *p_Altaircam_put_Speed )( cameraInfo->handle, val )) {
    ...
    case OA_CAM_CTRL_HUE:
      ...
      if ( val >= TOUPCAM_HUE_MIN && val <= TOUPCAM_HUE_MAX ) {
        if (( *p_Altaircam_put_Hue )( cameraInfo->handle, val )) {
    ...
    case OA_CAM_CTRL_SATURATION:
      ...
      if ( val >= TOUPCAM_SATURATION_MIN && val <= TOUPCAM_SATURATION_MAX ) {
        if (( *p_Altaircam_put_Saturation )( cameraInfo->handle, val )) {
    ...
    case OA_CAM_CTRL_GREEN_BALANCE:
      ...
      if ( val >= TOUPCAM_WBGAIN_MIN && val <= TOUPCAM_WBGAIN_MAX ) {
        int gain[3];
        if (( *p_Altaircam_get_WhiteBalanceGain )( cameraInfo->handle, gain )) {
        ...
        if (( *p_Altaircam_put_WhiteBalanceGain )( cameraInfo->handle, gain )) {
...
_processGetControl ( ALTAIRCAM_STATE* cameraInfo, OA_COMMAND* command )
{
  ...
  switch ( control ) {
    ...
    case OA_CAM_CTRL_BRIGHTNESS:
      ...
      if (( *p_Altaircam_get_Brightness )( cameraInfo->handle, &val_s32 )) {
    ...
    case OA_CAM_CTRL_CONTRAST:
      valp->valueType = OA_CTRL_TYPE_INT32;
      if (( *p_Altaircam_get_Contrast )( cameraInfo->handle, &val_s32 )) {
    ...
    case OA_CAM_CTRL_GAMMA:
      valp->valueType = OA_CTRL_TYPE_INT32;
      if (( *p_Altaircam_get_Gamma )( cameraInfo->handle, &val_s32 )) {
    ...
    case OA_CAM_CTRL_HFLIP:
      ...
      if (( *p_Altaircam_get_HFlip )( cameraInfo->handle, &val_s32 )) {
    ...
    case OA_CAM_CTRL_VFLIP:
      valp->valueType = OA_CTRL_TYPE_BOOLEAN;
      if (( *p_Altaircam_get_VFlip )( cameraInfo->handle, &val_s32 )) {
    ...
    case OA_CAM_CTRL_MODE_AUTO( OA_CAM_CTRL_EXPOSURE_ABSOLUTE ):
      valp->valueType = OA_CTRL_TYPE_BOOLEAN;
      if (( *p_Altaircam_get_AutoExpoEnable )( cameraInfo->handle, &val_s32 )) {
    ...
    case OA_CAM_CTRL_EXPOSURE_ABSOLUTE:
      valp->valueType = OA_CTRL_TYPE_INT32;
      if (( *p_Altaircam_get_ExpoTime )( cameraInfo->handle, &val_u32 )) {
    ...
    case OA_CAM_CTRL_GAIN:
      valp->valueType = OA_CTRL_TYPE_INT32;
      if (( *p_Altaircam_get_ExpoAGain )( cameraInfo->handle, &val_u16 )) {
    ...
    case OA_CAM_CTRL_SPEED:
      valp->valueType = OA_CTRL_TYPE_INT32;
      if (( *p_Altaircam_get_Speed )( cameraInfo->handle, &val_u16 )) {
    ...
    case OA_CAM_CTRL_HUE:
      valp->valueType = OA_CTRL_TYPE_INT32;
      if (( *p_Altaircam_get_Hue )( cameraInfo->handle, &val_s32 )) {
    ...
    case OA_CAM_CTRL_SATURATION:
      valp->valueType = OA_CTRL_TYPE_INT32;
      if (( *p_Altaircam_get_Saturation )( cameraInfo->handle, &val_s32 )) {
    ...
    case OA_CAM_CTRL_TEMPERATURE:
      valp->valueType = OA_CTRL_TYPE_INT32;
      if (( *p_Altaircam_get_Temperature )( cameraInfo->handle, &val_s16 )) {
...
_processSetResolution ( ALTAIRCAM_STATE* cameraInfo, OA_COMMAND* command )
{
  ...
  if (( *p_Altaircam_put_Roi )( cameraInfo->handle, 0, 0, 0, 0 )) {
    fprintf ( stderr, "Can't clear Altaircam ROI\n" );
    return -OA_ERR_CAMERA_IO;
  }

  if (( *p_Altaircam_put_Size )( cameraInfo->handle, size->x, size->y )) {
...
_processSetROI ( oaCamera* camera, OA_COMMAND* command )
{
  ...
  if (( *p_Altaircam_put_Roi )( cameraInfo->handle, offsetX, offsetY, x, y )) {
...
_doStart ( ALTAIRCAM_STATE* cameraInfo )
{
  ...
  if (( ret = ( *p_Altaircam_StartPushMode )( cameraInfo->handle,
      _AltairFrameCallback, cameraInfo ))) {
...
_doStop ( ALTAIRCAM_STATE* cameraInfo )
{
  ...
  if (( ret = ( *p_Altaircam_Stop )( cameraInfo->handle ))) {
...
_setBinning ( ALTAIRCAM_STATE* cameraInfo, int binMode )
{
  ...
  if (( *p_Altaircam_put_Size )( cameraInfo->handle, x, y )) {
...
static int
_setBitDepth ( ALTAIRCAM_STATE* cameraInfo, int depth )
{
  if  ( depth != 8 && depth != 16 ) {
    return -OA_ERR_OUT_OF_RANGE;
  }
