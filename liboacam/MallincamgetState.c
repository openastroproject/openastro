/*****************************************************************************
 *
 * MallincamgetState.c -- state querying for Mallincam cameras
 *
...
int
oaMallincamCameraGetControlRange ( oaCamera* camera, int control, int64_t* min,
...
const FRAMESIZES*
oaMallincamCameraGetFrameSizes ( oaCamera* camera )
{
...
int
oaMallincamCameraGetFramePixelFormat ( oaCamera* camera, int depth )
{
  MALLINCAM_STATE*	cameraInfo = camera->_private;
