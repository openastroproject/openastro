...
#define QHY5II_DEFAULT_EXPOSURE		100
#define QHY5II_DEFAULT_SPEED		0
#define QHY5II_DEFAULT_USBTRAFFIC	128
#define QHY5II_IMAGE_OFFSET		5

#define QHY5II_MONO_GAIN_MIN		1
#define QHY5II_MONO_GAIN_MAX		48
