...
int
oaAltairLegacyCameraReadControl ( oaCamera* camera, int control,
    oaControlValue* val )
{
  OA_COMMAND		command;
  ALTAIRCAM_STATE*	cameraInfo = camera->_private;
...
int
oaAltairLegacyCameraTestControl ( oaCamera* camera, int control,
    oaControlValue* valp )
{
  int32_t		val_s32;
  ALTAIRCAM_STATE*	cameraInfo = camera->_private;
...
int
oaAltairLegacyCameraSetResolution ( oaCamera* camera, int x, int y )
{
  FRAMESIZE		s;
  OA_COMMAND		command;
  ALTAIRCAM_STATE*	cameraInfo = camera->_private;
...
int
oaAltairLegacyCameraSetROI ( oaCamera* camera, int x, int y )
{
  FRAMESIZE		s;
  OA_COMMAND		command;
  ALTAIRCAM_STATE*	cameraInfo = camera->_private;
...
int
oaAltairLegacyCameraStartStreaming ( oaCamera* camera,
...
int
oaAltairLegacyCameraIsStreaming ( oaCamera* camera )
{
  ALTAIRCAM_STATE*  cameraInfo = camera->_private;
...
int
oaAltairLegacyCameraStopStreaming ( oaCamera* camera )
{
  OA_COMMAND		command;
  int			retval;
  ALTAIRCAM_STATE*	cameraInfo = camera->_private;
...
const char*
oaAltairLegacyCameraGetMenuString ( oaCamera* camera, int control, int index )
{ 
