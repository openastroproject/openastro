...
int
oaAltairLegacyCameraGetControlRange ( oaCamera* camera, int control,
...
const FRAMESIZES*
oaAltairLegacyCameraGetFrameSizes ( oaCamera* camera )
{
...
int
oaAltairLegacyCameraGetFramePixelFormat ( oaCamera* camera )
{
  ALTAIRCAM_STATE*	cameraInfo = camera->_private;
...
int
oaAltairLegacyCameraGetControlDiscreteSet ( oaCamera* camera, int control,
