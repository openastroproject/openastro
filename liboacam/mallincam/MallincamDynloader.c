/*****************************************************************************
 *
 * MallincamDynloader.c -- handle dynamic loading of libmallincam
 *
...
unsigned	( *p_Mallincam_EnumV2 )( ToupcamInstV2* );
...
HRESULT		( *p_Mallincam_PullImageV2 )( HToupCam, void*, int,
			    ToupcamFrameInfoV2* );
...
int
_mallincamInitLibraryFunctionPointers ( void )
{
