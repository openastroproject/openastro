/*****************************************************************************
 *
 * qhyccdgetState.c -- state querying for libqhyccd
 *
...
int
oaQHYCCDCameraGetControlRange ( oaCamera* camera, int control, int64_t* min,
...
const FRAMESIZES*
oaQHYCCDCameraGetFrameSizes ( oaCamera* camera )
{
...
int
oaQHYCCDCameraGetFramePixelFormat ( oaCamera* camera )
{
  QHYCCD_STATE*	cameraInfo = camera->_private;
...
int
oaQHYCCDCameraGetControlDiscreteSet ( oaCamera* camera, int control,
