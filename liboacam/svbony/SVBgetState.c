/*****************************************************************************
 *
 * SVBgetState.c -- state querying for SVBony cameras
 *
...
int
oaSVBCameraGetFramePixelFormat ( oaCamera *camera )
{
...
int
oaSVBCameraGetControlRange ( oaCamera* camera, int control, int64_t* min,
...
const FRAMESIZES*
oaSVBCameraGetFrameSizes ( oaCamera* camera )
{
  SVB_STATE*		cameraInfo = camera->_private;
