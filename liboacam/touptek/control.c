...
int
TT_FUNC( oa, CameraSetControl )( oaCamera* camera, int control,
...
int
TT_FUNC( oa, CameraReadControl )( oaCamera* camera, int control,
    oaControlValue* val )
{
  OA_COMMAND		command;
  TOUPTEK_STATE*	cameraInfo = camera->_private;
...
int
TT_FUNC( oa, CameraSetResolution )( oaCamera* camera, int x, int y )
{
  FRAMESIZE		s;
  OA_COMMAND		command;
  TOUPTEK_STATE*	cameraInfo = camera->_private;
...
int
TT_FUNC( oa, CameraStartStreaming )( oaCamera* camera,
    void* (*callback)(void*, void*, int, void* ), void* callbackArg )
{
  ...
  oacamDebugMsg ( DEBUG_CAM_CTRL, TT_DRIVER ": control: %s ( %p )\n",
...
int
TT_FUNC( oa, CameraIsStreaming )( oaCamera* camera )
{
  TOUPTEK_STATE*  cameraInfo = camera->_private;
...
int
TT_FUNC( oa, CameraStopStreaming )( oaCamera* camera )
{
  OA_COMMAND		command;
  int			retval;
  TOUPTEK_STATE*	cameraInfo = camera->_private;

  oacamDebugMsg ( DEBUG_CAM_CTRL, TT_DRIVER ": control: %s()\n", __FUNCTION__ );
