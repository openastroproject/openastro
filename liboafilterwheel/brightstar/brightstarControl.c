/*****************************************************************************
 *
 * brightstarControl.c -- Brightstar filter wheel control functions
 *
...
int
oaBrightstarWheelSetControl ( oaFilterWheel* wheel, int control,
		oaControlValue* val )
{
  OA_COMMAND	command;
...
int
oaBrightstarWheelReadControl ( oaFilterWheel* wheel, int control,
		oaControlValue* val )
{
  OA_COMMAND	command;
