/*****************************************************************************
 *
 * xagylControl.c -- Xagyl filter wheel control functions
 *
...
int
oaXagylWheelSetControl ( oaFilterWheel* wheel, int control, oaControlValue* val )
{
  OA_COMMAND	command;
...
int
oaXagylWheelReadControl ( oaFilterWheel* wheel, int control, oaControlValue* val )
{
  OA_COMMAND	command;
...
/*
int
oaXagylWheelTestControl ( oaFilterWheel* wheel, int control, oaControlValue* val )
{
  uint32_t      val_u32;
  int64_t       val_s64;
