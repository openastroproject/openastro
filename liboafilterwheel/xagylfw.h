...
extern int              oaXagylWheelTestControl ( oaFilterWheel*, int,
                                oaControlValue* );
extern int              oaXagylWheelSetControl ( oaFilterWheel*, int,
                                oaControlValue* );
extern int              oaXagylWheelReadControl ( oaFilterWheel*, int,
                                oaControlValue* );
