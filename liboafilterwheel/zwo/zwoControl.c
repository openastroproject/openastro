/*****************************************************************************
 *
 * zwoControl.c -- ZWO filter wheel control functions
 *
...
int
oaZWOWheelSetControl ( oaFilterWheel* wheel, int control, oaControlValue* val )
{
  OA_COMMAND	command;
...
int
oaZWOWheelReadControl ( oaFilterWheel* wheel, int control, oaControlValue* val )
{
  OA_COMMAND	command;
...
/*
int
oaZWOWheelTestControl ( oaFilterWheel* wheel, int control, oaControlValue* val )
{
  uint32_t      val_u32;
  int64_t       val_s64;
